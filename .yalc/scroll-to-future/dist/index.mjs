...
var useElementScrollObserver = (target) => {
  const [metrics, setMetrics] = useState2(getEmptyMetrics);
...
var ScrollToFuture = ({
  ...
  const [findedTarget, setFindedTarget] = useState4(null);
  const config = merge({
    scrollBar,
    thumb,
    selectTheme,
  ...
  const overlay = overlayEnabled && findedTarget ? /* @__PURE__ */ jsxs(
    "div",
    {
      ref: overlayRef,
      ...
      children: [
        horizontalReservedSpace > 0 && /* @__PURE__ */ jsx2(
          "div",
          {
