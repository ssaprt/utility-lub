...
var TooltipSurface = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { ref: arrowProbeRef, className: "tooltip-arrow-probe" }),
    metrics.path ? /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          metrics.strokeWidth > 0 ? /* @__PURE__ */ jsx(
            "svg",
            {
...
var TooltipProvider = ({
  ...
  return /* @__PURE__ */ jsx2(TooltipContext.Provider, { value, children });
};
