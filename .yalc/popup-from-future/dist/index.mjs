    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "ssaprt-popup__close-timer-value", children: seconds })
        ]
      }
    );
  }
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: closeClassName, style: config.close.style, children: [
                  showTimer && /* @__PURE__ */ jsx(
                    CloseTimer,
                    {
                  ...
                  showCloseButton && (CloseComponent ? /* @__PURE__ */ jsx(CloseComponent, { close: handleClose }) : /* @__PURE__ */ jsx(
                    "button",
                    {
                      type: "button",
                      ...
                      onClick: handleClose,
                      children: config.close.icon ?? /* @__PURE__ */ jsx(
                        "span",
                        {
